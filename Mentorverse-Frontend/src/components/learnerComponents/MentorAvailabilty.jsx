...
const MentorAvailabilty = ({ mentorSlots, selectedSlot, onHandleSelectedSlot }) => {


  return (
    <div className="mt-8 bg-white rounded-2xl shadow-(--shadow-primary) p-8 flex flex-col gap-6 col-start-1 col-end-3">
